...
def weights_init(m):
    ...
    if classname.find('Conv') != -1:
        m.weight.data.normal_(0.0, 0.02) # normal distribution mean=0.0, std=0.02
...
class Generator(nn.Module):
    ...
    def __init__(self, in_dim, dim=64):
        ...
        #     nn.ReLU()
        # )
        # self.l1 = dconv_bn_relu(in_dim, dim * 8)
...
log_dir = os.path.join(workspace_dir, '2021_HW6/logs_10e')
ckpt_dir = os.path.join(workspace_dir, '2021_HW6/checkpoints_10e')
...
for e, epoch in enumerate(range(n_epoch)):
    ...
    for i, data in enumerate(progress_bar):
        ...
        progress_bar.set_description(f"Loss_D: {round(loss_D.item(), 4)}, Loss_G: {round(loss_G.item(), 4)}, Epoch: {e + 1}, Step: {steps},")
